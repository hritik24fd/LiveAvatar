...
const SPEECH_KEY = "02eb5749f2c2434b84c438463ff2bc5e";
const OPENAI_ENDPOINT = "https://liveavatar.openai.azure.com/";
const OPENAI_KEY = "DV1C3LHFJXFyBC8gzDEjBUdPxILpBvHWKqoV0mBhLkIZ89Vc4KuQJQQJ99BCACfhMk5XJ3w3AAABACOGX1QO";
const OPENAI_DEPLOYMENT_NAME = "gpt-4o";


const TTS_VOICE = "en-US-AvaMultilingualNeural";
const PERSONAL_VOICE_ID = "";
...
function resetInactivityTimer() {
    ...
    inactivityTimer = setTimeout(() => {
        console.log("No user activity for 30s => stopping session.");
        stopSession();
        revertToLocalIdle();
    }, INACTIVITY_LIMIT_MS);
}
